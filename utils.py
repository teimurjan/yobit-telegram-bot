...
from constants import LOGGER_NAME, LOGGER_FORMAT, LOGGER_FILE_NAME, LOGGER_UPDATE_VALUE, LOGGER_UPDATE_INTERVAL, \
  LOGGER_BACKUP_COUNT
...
def setup_logger():
  ...
  handler = TimedRotatingFileHandler(LOGGER_FILE_NAME,
